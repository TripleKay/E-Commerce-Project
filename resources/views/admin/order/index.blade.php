            ...
            <div class="card-header">
               <div class="d-flex align-items-center justify-content-between my-1">
                    ...
                    <div class="d-flex align-items-center">
                        <label for="" class="mr-2 mb-0 font-weight-normal">Filter:</label>
                        <select name="" id="" class="custom-select">
                            <option value="">All Order</option>
                            <option value="">Pending Order</option>
                            <option value="">Confirm Order</option>
                            <option value="">Processing Order</option>
                        </select>
                    </div>
               </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('admin#showOrder',$item->order_id) }}" class="btn btn-sm btn-dark text-white"><i class="fas fa-download me-2"></i>Invoice</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
